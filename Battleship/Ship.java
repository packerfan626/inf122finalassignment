...
public class Ship
{
	...
	private boolean shipCoords[][] = new boolean[10][10]; // I DON'T THINK WE
															// NEED THIS
...
//		}
	...
	{
		System.out.println("SHIP X: " + y + "SHIP Y: " + x);
		return shipCoords[y][x];
